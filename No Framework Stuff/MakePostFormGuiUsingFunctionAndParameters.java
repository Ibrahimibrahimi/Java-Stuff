...
class MakePostFormGuiUsingFunctionAndParameters {
	public static JPanel makePost(String text , String author){
		// create post model
	...
	public static void main(String[] args) {
		...
		root.add(makePost("this is a post", "ibrahim id-wahman"));
		root.add(makePost("this is a post", "ibrahim id-wahman"));
		root.add(makePost("this is a post", "ibrahim id-wahman"));
